...
- name: Prepare
  ...
  roles:
    ...
    - role: buluma.repo_epel
      when:
        - (ansible_distribution == "Amazon" and ansible_distribution_major_version == "2") or (ansible_os_family == "RedHat" and
...
### Get Help
- Report issues: https://github.com/buluma/ansible-role-security/issues/new
- See docs: https://docs.ansible.com/collection/gallery/ansible-role-security
